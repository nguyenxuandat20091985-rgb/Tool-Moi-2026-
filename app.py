...
# Fixed: Login/Register, QR Code, Eye Strain, Auto-Update
# =============================================================================
...
# =============================================================================
# 💳 PAYOS - SIMPLIFIED (QR CODE LINK)
# =============================================================================
def create_payos_payment(order_code, amount, description):
    """Tạo link thanh toán PayOS - TRẢ VỀ LINK TRỰC TIẾP"""
    ...
    try:
        ...
        st.error(f"Lỗi kết nối PayOS: {str(e)}")
        return None

def display_pricing_table():
    """Hiển thị bảng giá với QR CODE hoặc LINK"""
                    ...
                    if payment_info:
                        ...
                        if checkout_url:
                            ...
                            <div class="payment-info">
                                <p style="margin: 0 0 10px 0; font-size: 14px; color: #58a6ff;">
                                    🔗 Hoặc thanh toán qua link:
                                </p>
                                ...
                                <p style="margin: 10px 0 0 0; font-size: 13px; color: #8b949e;">
                                    ⏳ VIP sẽ được kích hoạt trong 5-10 phút sau khi thanh toán
                                </p>
                            </div>
                            ''', unsafe_allow_html=True)
                        else:
